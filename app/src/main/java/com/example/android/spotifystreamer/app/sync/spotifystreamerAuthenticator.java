...
/**
 * Manages "Authentication" to spotifystreamer's backend service.  The SyncAdapter framework
 ...
 */
public class spotifystreamerAuthenticator extends AbstractAccountAuthenticator {

    public spotifystreamerAuthenticator(Context context) {
        super(context);
    }
